...
def slice_foods():
    # your code here
    foods = (' chicken ',' burger ', ' pizza ', ' pasta ', ' rice ')
...
def hometown_info():
    # your code here
  home_town = {'city': 'Riffa', 'state': 'Bahrain', 'population': '500,000'}

  home_town_message = f"I was born in {home_town['city']}, {home_town['state']} , the population {home_town['population']}"
